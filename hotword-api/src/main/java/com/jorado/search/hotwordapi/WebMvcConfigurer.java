...
import com.jorado.search.hotwordapi.util.HttpUtils;
...
public class WebMvcConfigurer extends WebMvcConfigurerAdapter {
        ...
        registry.addInterceptor(new HandlerInterceptorAdapter() {
                                    ...
                                    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
                                        ...
                                        if (RemoteSettings.enabled()) {
                                            ...
                                            responseResult(response, new Result(ResultStatus.FORBIDDEN, "热词联想已关闭"));
                                            return false;
                                        }
                                    }
                                }
        ).addPathPatterns("/suggest/**");
    }
    ...
    private void responseResult(HttpServletResponse response, Result result) {
        ...
        try {
            ...
            EventClient.getDefault().asyncSubmitException(ex.getMessage(), ex);
        }
    }
}