...
public class OfflineTest {
    ...
    public void testExecute() throws Exception {
        ...
        String output = offline.execute(mock(CommandContext.class), new String[]{"com.jorado.BarService"});
        ...
        output = offline.execute(mock(CommandContext.class), new String[]{"com.jorado.FooService"});
