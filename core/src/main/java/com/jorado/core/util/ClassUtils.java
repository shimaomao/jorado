...
public class ClassUtils {
    ...
    private static final Map<Class<?>, Map<String, Method>> GETTER_CACHE = new ConcurrentHashMap<Class<?>, Map<String, Method>>();

    private static final Map<String, Class<?>> CLASS_CACHE = new ConcurrentHashMap<String, Class<?>>();

    private static final Map<String, Set<Class<?>>> CLASS_CACHES = new ConcurrentHashMap<>();
    ...
    public static Set<Class<?>> getClasses(String pack) {
        ...
        if (CLASS_CACHES.containsKey(pack)) {
            return CLASS_CACHES.get(pack);
        }
    ...
    public static Set<Class<?>> getClasses(String pack, Class<?> t) {
        Set<Class<?>> classes = getClasses(pack);
        return getByInterface(t, classes);
    }
