package com.jorado.search.solrextend.util;
...
//                        break;
    ...
    public static void main(String[] args) throws ParseException {
        String testSplit = "1;2;3;;";
        String[] splits = splitString(testSplit, ";", false);
        ...
        System.out.println(escapeSolrString("sd)+&#f(ds"));
        System.out.println(removeSpecialChar("男/*+-!@#,.:;”’，。人？“$%^&(-={}[]<>?”:"));
    }
}
