...
public abstract class ZKPConfig<T> extends HashMap<String, T> {
    ...
    public void updateConfig(ZKPConfig current) {
        ZKPConfig config = ConfigFactory.get(this.path);
    ...
    public static void main(String[] args) {
        ZKPConfig config = ConfigFactory.get(AppSettings.ZKP_PATH);
